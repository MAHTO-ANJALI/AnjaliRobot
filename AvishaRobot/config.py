...
class Config(object):
    ...
    OWNER_ID = os.getenv("OWNER_ID", "6260080241")
    OWNER_USERNAME = ("OWNER_USERNAME", "AnjaliOwnerBot")
    SUPPORT_CHAT = os.getenv("SUPPORT_CHAT", "ANJALINETWORK")
    START_IMG = os.getenv("START_IMG", "https://graph.org/file/eaa3a2602e43844a488a5.jpg")
    JOIN_LOGGER = os.getenv("JOIN_LOGGER", "-1001970031336")
    EVENT_LOGS = os.getenv("EVENT_LOGS", "-1001970031336")
    ERROR_LOGS = os.getenv("ERROR_LOGS", "-1001970031336")
    MONGO_DB_URI = os.getenv("MONGO_DB_URI", None)
    LOG_CHANNEL = os.getenv("LOG_CHANNEL", "-1002126562358")
    BOT_USERNAME = os.getenv("BOT_USERNAME", "TheAnjaliRobot")
    ...
    SPAMWATCH_SUPPORT_CHAT = os.getenv("SPAMWATCH_SUPPORT_CHAT", "ANJALIWORLD")
